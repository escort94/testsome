...
public class AuditOptLogRequest extends Request
{
  ...
  public AuditOptLogRequest()
  {
    super.setOperation("AUDITQUERYLOG");
  }

  public AuditOptLogRequest(Request paramRequest)
  ...
  public AuditOptLogRequest(byte[] paramArrayOfByte)
    throws AuditException
  {
    try
    {
 ...
 * Qualified Name:     cn.com.jit.ida.ca.audit.service.request.AuditOptLogRequest
