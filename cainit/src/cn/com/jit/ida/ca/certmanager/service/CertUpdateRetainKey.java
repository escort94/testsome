...
import cn.com.jit.ida.ca.certmanager.service.request.CertUPDRetainKeyRequest;
import cn.com.jit.ida.ca.certmanager.service.response.CertUpdateRetainKeyResponse;
...
public class CertUpdateRetainKey extends CertService
{
  ...
  private CertUpdateRetainKeyResponse response = new CertUpdateRetainKeyResponse();
  ...
  public Response dealRequest(Request paramRequest)
  {
    try
    {
      ...
      localObject1 = localInternalConfig.getAdminTemplateName();
      X509Cert localX509Cert = null;
      if (this.ctmlName.equals(localObject1))
      {
        if (this.attributes == null)
          localX509Cert = CertUPDDownOpt.certUPDDown(localCertRevokeInfo, this.certInfo, true);
        else
          localX509Cert = CertUPDDownOpt.certUPDDown(localCertRevokeInfo, this.certInfo, this.attributes, true);
      }
      else if (this.attributes == null)
        localX509Cert = CertUPDDownOpt.certUPDDown(localCertRevokeInfo, this.certInfo, false);
      else
        localX509Cert = CertUPDDownOpt.certUPDDown(localCertRevokeInfo, this.certInfo, this.attributes, false);
      this.response.setCertSN(this.certSN);
      Object localObject5;
      if (this.returnP7B)
      {
        localObject2 = CAConfig.getInstance();
        localObject3 = ((CAConfig)localObject2).getRootCerts();
        localObject4 = new X509Cert[localObject3.length + 1];
        for (int i = 0; i < localObject3.length; i++)
          localObject4[i] = localObject3[i];
        localObject4[(localObject4.length - 1)] = localX509Cert;
        localObject5 = new P7B();
        byte[] arrayOfByte = null;
        try
        {
          arrayOfByte = ((P7B)localObject5).generateP7bData_B64(localObject4);
        }
      ...
      {
        localObject2 = this.keyPair.getPrivateKey();
        localObject3 = new PKCS12();
        localObject4 = ((PKCS12)localObject3).generatePfxData((JKey)localObject2, localX509Cert, "JIT".toCharArray());
        localObject5 = new String(Base64.encode(localObject4));
        this.debugLogger.appendMsg_L2("pfx=" + (String)localObject5);
        this.response.setPfx((String)localObject5);
      }
      Object localObject2 = new KeyStateTrackRequest();
      ((KeyStateTrackRequest)localObject2).setCertsn(this.oldCertSN);
      ((KeyStateTrackRequest)localObject2).setKeystate("revoked");
      Object localObject3 = new KMCConnector();
      Object localObject4 = ((KMCConnector)localObject3).updateKeyStateFromKMC((KeyStateTrackRequest)localObject2);
      if ((localObject4 != null) && (localObject4.equals("0")));
  ...
  protected void validateCheck()
    throws CertException
  {
    CertUPDRetainKeyRequest localCertUPDRetainKeyRequest = new CertUPDRetainKeyRequest(this.request);
    this.oldCertSN = localCertUPDRetainKeyRequest.getCertSN();
    this.certDN = localCertUPDRetainKeyRequest.getCertDN();
    this.ctmlName = localCertUPDRetainKeyRequest.getCtmlName();
    this.notBefore = localCertUPDRetainKeyRequest.getNotBefore();
    this.validity = localCertUPDRetainKeyRequest.getValidity();
    this.p10 = localCertUPDRetainKeyRequest.getP10();
    this.tempPubKey = localCertUPDRetainKeyRequest.getTempPubKey();
    ...
    else
    {
      ...
      else if (str2.equals("CA"))
      {
        ...
        if (((String)localObject1).equals("RSA"))
        {
          ...
          try
          {
            this.keyPair = localSession.generateKeyPair((Mechanism)localObject3, k);
          }
 ...
 * Qualified Name:     cn.com.jit.ida.ca.certmanager.service.CertUpdateRetainKey
