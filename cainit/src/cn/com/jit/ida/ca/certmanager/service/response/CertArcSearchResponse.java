...
public class CertArcSearchResponse extends Response
{
  private CertInfo[] certInfos = null;
  private String totalRowCount = null;

  public CertArcSearchResponse()
  {
    super.setOperation("SUPERQUERYARCHIVECERT");
  }

  public CertArcSearchResponse(byte[] paramArrayOfByte)
    throws IDAException
  {
    try
    {
  ...
  public CertArcSearchResponse(Response paramResponse)
    throws IDAException
  {
    try
    {
 ...
 * Qualified Name:     cn.com.jit.ida.ca.certmanager.service.response.CertArcSearchResponse
