...
public class CertQueryResponse extends Response
{
  private CertInfo[] certInfos = null;
  private String totalRowCount = null;

  public CertQueryResponse()
  {
    super.setOperation("CERTQUERY");
  }

  public CertQueryResponse(byte[] paramArrayOfByte)
    throws IDAException
  {
    try
    {
  ...
  public CertQueryResponse(Response paramResponse)
    throws IDAException
  {
    try
    {
 ...
 * Qualified Name:     cn.com.jit.ida.ca.certmanager.service.response.CertQueryResponse
