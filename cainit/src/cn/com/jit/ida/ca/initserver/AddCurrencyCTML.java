...
public class AddCurrencyCTML extends AddCTML
{
  protected void makeReq()
    throws IDAException
  {
    super.makeReq();
    this.request.setName("通用证书模板");
    this.request.setType("X509V3");
    this.request.setDescription("用于签发既包含签名用途又包含加密用途的证书");
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddCurrencyCTML
