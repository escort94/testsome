...
public class AddCrossCertCTML extends AddCTML
{
  protected void makeReq()
    throws IDAException
  {
    super.makeReq();
    this.request.setName("交叉证书模板");
    this.request.setType("X509V3");
    this.request.setDescription("用于签发CA的交叉认证证书");
    ...
    localX509V3CTMLPolicy.getAttribute().attribute = 1L;
    ...
    localBasicConstraintsPolicy.setCrucial(true);
    localBasicConstraintsPolicy.setCAConstraint(true);
    localHashtable.put("BasicConstraints", localBasicConstraintsPolicy);
    PolicyMappingsPolicy localPolicyMappingsPolicy = new PolicyMappingsPolicy();
    localPolicyMappingsPolicy.setCrucial(false);
    localPolicyMappingsPolicy.setPolicyMappingsAllowNull("FALSE");
    localHashtable.put("PolicyMappings", localPolicyMappingsPolicy);
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddCrossCertCTML
