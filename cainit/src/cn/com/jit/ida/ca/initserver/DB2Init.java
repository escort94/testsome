...
public class DB2Init extends DBInit
{
  DB2Init()
    throws DBException
  {
    ...
    throws DBException
  {
    ...
    try
    {
      String str3 = "./config/db/db2/tables.sql";
      ...
      while ((str2 = localBufferedReader.readLine()) != null)
      {
        ...
        if (str2.endsWith(";"))
        {
          str1 = str1 + " " + str2.substring(0, str2.length() - 1);
          try
          {
          ...
          {
            if (localSQLException1.getErrorCode() != -204)
            {
              if (localSQLException1.getErrorCode() == -428)
                throw new DBException("8081", "数据库异常：默认表空间页大小不够");
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.DB2Init
