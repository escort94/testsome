...
public class AddAcrossCertCTML extends AddCTML
{
  protected void makeReq()
    throws IDAException
  {
    super.makeReq();
    this.request.setName("CA证书模板");
    this.request.setType("X509V3");
    this.request.setDescription("用于签发子CA签名证书或其它CA证书");
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddAcrossCertCTML
