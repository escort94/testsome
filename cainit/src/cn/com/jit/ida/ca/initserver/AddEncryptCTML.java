...
public class AddEncryptCTML extends AddCTML
{
  protected void makeReq()
    throws IDAException
  {
    super.makeReq();
    this.request.setName("加密证书模板");
    this.request.setType("X509V3");
    this.request.setDescription("用于签发做为加密用途的证书");
    ...
    localX509V3CTMLPolicy.getKeyPolicy().genPlace = "KMC";
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddEncryptCTML
