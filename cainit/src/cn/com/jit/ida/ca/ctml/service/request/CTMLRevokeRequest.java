...
public class CTMLRevokeRequest extends Request
{
  ...
  public CTMLRevokeRequest()
  {
    super.setOperation("CTMLREVOKE");
  }

  public CTMLRevokeRequest(Request paramRequest)
    throws IDAException
  {
    try
    {
  ...
  public CTMLRevokeRequest(byte[] paramArrayOfByte)
    throws IDAException
  {
    try
    {
 ...
 * Qualified Name:     cn.com.jit.ida.ca.ctml.service.request.CTMLRevokeRequest
