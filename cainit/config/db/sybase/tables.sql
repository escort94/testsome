...
create table cert (
     ...
     notbefore            numeric(19)                    not null,
     notafter             numeric(19)                    not null,
     validity             int                            not null,
     authcode             varchar(60)                    not null,
     cdpid                int                            not null,
     ctmlname             varchar(128)                   not null,
     certstatus           varchar(12)                    not null,
     isvalid              numeric(19)                    not null,
     createtime           numeric(19)                    null,
     applicantuppercase   varchar(255)                   not null,
     applicant            varchar(255)                   not null,
     certentity           image                          null,
     email                varchar(100)                   null,
     remark               varchar(255)                   null,
     authcode_updatetime  numeric(19)                    null,
     sign_server          text                           null,
     sign_client          text                           null,
...
create table revokedcert (
     certsn               varchar(40)                    not null,
     cdpid                numeric(19)                    not null,
     reason               tinyint                        not null,
     reasondesc           varchar(255)                   null,
     revoketime           numeric(19)                    not null,
     sign_server          text                           null,
     sign_client          text                           null,
     certnotafter         numeric(19)                    null,
...
create table rootcert (
     ...
     ca_id                decimal(19)                    not null,
     ca_desc              varchar(255)                   null,
     subjectuppercase     varchar(255)                   not null,
     private_key          text                           not null,
     certstatus           varchar(12)                    not null,
     certentity           image                          not null,
