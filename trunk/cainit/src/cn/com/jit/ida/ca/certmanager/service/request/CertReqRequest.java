...
public class CertReqRequest extends Request
{
  ...
  public CertReqRequest()
  {
    super.setOperation("CERTREQUST");
  }

  public CertReqRequest(Request paramRequest)
  ...
  public CertReqRequest(byte[] paramArrayOfByte)
    throws CertException
  {
    try
    {
    ...
    throws CertException
  {
    if (paramBoolean)
    {
      ...
      {
        localElement2 = XMLTool.newElement(this.doc, "validity", this.validate);
        localElement1.appendChild(localElement2);
      }
      if (this.email != null)
      {
    ...
    else
    {
      ...
      this.validate = XMLTool.getValueByTagName(this.body, "validity");
      this.validate = XMLTool.getValueByTagName(this.body, "validity");
      this.validate = XMLTool.getValueByTagName(this.body, "validity");
    ...
    throws IDAException
  {
    if ((paramString == null) || (paramString.trim().equals("")) || (!ReqCheck.checkDN(paramString)))
      throw new IDAException("81010801", "证书申请服务 设置申请信息错误 证书主题内容错误");
    ...
    throws IDAException
  {
    if ((paramString == null) || (paramString.trim().equals("")))
      throw new IDAException("81010802", "证书申请服务 设置申请信息错误 模板名称内容错误");
    ...
    throws IDAException
  {
    ...
    if (!ReqCheck.checkNotBefore(str))
      throw new IDAException("81010803", "证书申请服务设置申请信息错误 起始有效期内容错误");
    this.notBefore = str;
  }
    ...
    throws IDAException
  {
    ...
    if (!ReqCheck.checkValidity(str))
      throw new IDAException("81010804", "证书申请服务设置申请信息错误 有效期长度内容错误");
    this.validate = str;
  }
 ...
 * Qualified Name:     cn.com.jit.ida.ca.certmanager.service.request.CertReqRequest
