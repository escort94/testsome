...
public class OptLogSearchResponse extends Response
{
  private Operation[] optLogs = null;
  private String totalRowCount = null;

  public OptLogSearchResponse()
  {
    super.setOperation("AUDITQUERYARCHIVELOG");
  }

  public OptLogSearchResponse(Response paramResponse)
    throws LogException
  {
    try
    {
  ...
  public OptLogSearchResponse(byte[] paramArrayOfByte)
    throws LogException
  {
    try
    {
 ...
 * Qualified Name:     cn.com.jit.ida.ca.log.service.response.OptLogSearchResponse
