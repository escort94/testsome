...
public class CTMLSelfExtModifyRequest extends Request
{
  ...
  public CTMLSelfExtModifyRequest()
  {
    super.setOperation("CTMLSELFEXTMODIFY");
  }

  public CTMLSelfExtModifyRequest(Request paramRequest)
    throws IDAException
  {
    try
    {
  ...
  public CTMLSelfExtModifyRequest(byte[] paramArrayOfByte)
    throws IDAException
  {
    try
    {
 ...
 * Qualified Name:     cn.com.jit.ida.ca.ctml.service.request.CTMLSelfExtModifyRequest
