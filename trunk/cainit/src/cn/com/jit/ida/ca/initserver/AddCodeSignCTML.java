...
public class AddCodeSignCTML extends AddCTML
{
  protected void makeReq()
    throws IDAException
  {
    super.makeReq();
    this.request.setName("代码签名证书模板");
    this.request.setType("X509V3");
    this.request.setDescription("用于签发做为代码签名用途的证书");
    ...
    localExtendKeyUsagePolicy.addStandardKeyUsage("codeSigning");
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddCodeSignCTML
