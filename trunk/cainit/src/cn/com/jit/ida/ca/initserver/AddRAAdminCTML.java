...
public class AddRAAdminCTML extends AddCTML
{
    ...
    throws IDAException
  {
    ...
    super.makeReq();
    this.request.setName(localGlobalConfig.getInternalConfig().getRaadminTemplateName());
    this.request.setType("X509V3");
    this.request.setDescription("用于为RAServer签发业务管理员证书");
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddRAAdminCTML
