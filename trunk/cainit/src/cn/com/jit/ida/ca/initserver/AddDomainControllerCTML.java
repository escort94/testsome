...
public class AddDomainControllerCTML extends AddCTML
{
  protected void makeReq()
    throws IDAException
  {
    super.makeReq();
    this.request.setName("智能卡登录-域控制器模板");
    this.request.setType("X509V3");
    this.request.setDescription("用于签发Windows智能卡登录之域控制器证书");
    ...
    localExtendKeyUsagePolicy.addStandardKeyUsage("serverAuth");
    ...
    localSubjectAltNameExtPolicy.setOtherNameOid("1.3.6.1.4.1.311.25.1");
    localSubjectAltNameExtPolicy.setOtherName("TRUE");
    localSubjectAltNameExtPolicy.setOtherNameAllowNull("FALSE");
    localSubjectAltNameExtPolicy.setDnsName("TRUE");
    localSubjectAltNameExtPolicy.setDnsNameAllowNull("FALSE");
    ...
    localCertificateTemplatePolicy.setDomainController("domainController");
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddDomainControllerCTML
