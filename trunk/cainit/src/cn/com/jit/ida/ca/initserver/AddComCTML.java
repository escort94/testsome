...
public class AddComCTML extends AddCTML
{
    ...
    throws IDAException
  {
    ...
    super.makeReq();
    this.request.setName(localGlobalConfig.getInternalConfig().getCommCertTemplateName());
    this.request.setType("X509V3");
    this.request.setDescription("用于签发本系统使用的服务器证书");
    ...
    {
      throw new InitServerException(localIDAException3.getErrCode(), localIDAException3.getErrDesc(), localIDAException3);
    }
  }
}

/* Location:           C:\Program Files\JIT\CA50\lib\IDA\ida.jar
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddComCTML
