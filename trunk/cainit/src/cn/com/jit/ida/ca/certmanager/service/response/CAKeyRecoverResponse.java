...
public class CAKeyRecoverResponse extends Response
{
  ...
  public CAKeyRecoverResponse()
  {
  }

  public CAKeyRecoverResponse(byte[] paramArrayOfByte)
    throws IDAException
  {
    try
    {
  ...
  public CAKeyRecoverResponse(Response paramResponse)
    throws IDAException
  {
    try
    {
 ...
 * Qualified Name:     cn.com.jit.ida.ca.certmanager.service.response.CAKeyRecoverResponse
