...
public class CertDownload extends CertService
{
    ...
    try
    {
      ...
      if (this.ctmlName.equals("交叉证书模板"))
        try
        {
          ...
          if (j != -1)
            localObject5 = ((String)localObject2).substring(i + 1, j);
          else
            localObject5 = ((String)localObject2).substring(i + 1);
          File localFile1 = new File(str1);
          if (!localFile1.exists())
            localFile1.mkdir();
          String str2 = str1 + File.separator + (String)localObject5;
          File localFile2 = new File(str2);
          if (!localFile2.exists())
            localFile2.mkdir();
          FileOutputStream localFileOutputStream = new FileOutputStream(str2 + File.separator + "reverse.cer");
          localFileOutputStream.write(localX509Cert.getEncoded());
          localFileOutputStream.flush();
          localFileOutputStream.close();
          CertPairGenerator localCertPairGenerator = new CertPairGenerator(null, localX509Cert);
          byte[] arrayOfByte = localCertPairGenerator.generateCertPair();
          localFileOutputStream = new FileOutputStream(str2 + File.separator + "crosscert.dat");
        ...
        {
          throw new PKIException("0609", "执行业务操作 保存交叉证书失败", localException3);
        }
      Object localObject4;
      Object localObject6;
      if (this.returnP7B)
      ...
      Object localObject1 = CTMLManager.getInstance();
      localObject2 = null;
      ...
      if ((((String)localObject3).equals("KMC")) && (this.oldSN != null) && (!this.oldSN.equals("")))
      {
        KeyStateTrackRequest localKeyStateTrackRequest = new KeyStateTrackRequest();
        localKeyStateTrackRequest.setCertsn(this.oldSN);
    ...
    throws CertException
  {
    ...
    if (this.authCode.length() > 40)
    {
      ...
      throw new CertException("02", "数据有效性检查 授权码位数超长");
    }
    try
    {
    ...
    long l1 = this.certInfo.getAuthCodeUpdateTime();
    if (l1 != 0L)
    ...
    long l3 = l2 + i * 24L * 60L * 60L * 1000L;
    ...
    this.isRetainKey = this.certInfo.getIsRetainKey();
    this.oldSN = this.certInfo.getOldSN();
    ...
    throws CertException
  {
    ...
    if (str2.equals("LOCAL"))
    {
      ...
      localObject2 = localX509V3CTML.getKeyType();
    ...
    else
    {
      ...
      if (str2.equals("KMC"))
      {
        ...
        if ((this.isRetainKey != null) && (!this.isRetainKey.equals("")))
        {
          ((KMCCertInfo)localObject1).setRetainKey("true");
          ((KMCCertInfo)localObject1).setOldCertSN(this.isRetainKey);
        }
 ...
 * Qualified Name:     cn.com.jit.ida.ca.certmanager.service.CertDownload
