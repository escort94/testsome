...
public class CertArcSearchRequest extends Request
{
  ...
  public CertArcSearchRequest()
  {
    super.setOperation("SUPERQUERYARCHIVECERT");
  }

  public CertArcSearchRequest(Request paramRequest)
  ...
  public CertArcSearchRequest(byte[] paramArrayOfByte)
    throws CertException
  {
    try
    {
 ...
 * Qualified Name:     cn.com.jit.ida.ca.certmanager.service.request.CertArcSearchRequest
