...
public class CTMLSelfExtRevokeRequest extends Request
{
  ...
  public CTMLSelfExtRevokeRequest()
  {
    super.setOperation("CTMLSELFEXTREVOKE");
  }

  public CTMLSelfExtRevokeRequest(Request paramRequest)
    throws IDAException
  {
    try
    {
  ...
  public CTMLSelfExtRevokeRequest(byte[] paramArrayOfByte)
    throws IDAException
  {
    try
    {
 ...
 * Qualified Name:     cn.com.jit.ida.ca.ctml.service.request.CTMLSelfExtRevokeRequest
