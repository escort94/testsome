...
public class AddSSLServerCTML extends AddCTML
{
  protected void makeReq()
    throws IDAException
  {
    super.makeReq();
    this.request.setName("SSL服务器证书模板");
    this.request.setType("X509V3");
    this.request.setDescription("用于签发SSL服务器证书");
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddSSLServerCTML
