...
public class AddTSAServerCTML extends AddCTML
{
  protected void makeReq()
    throws IDAException
  {
    super.makeReq();
    this.request.setName("时间戳签名证书模板");
    this.request.setType("X509V3");
    this.request.setDescription("用于签发时间戳服务器签名证书");
    ...
    localExtendKeyUsagePolicy.addStandardKeyUsage("timeStamping");
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.AddTSAServerCTML
