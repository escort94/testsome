...
public class MSSQLInit extends DBInit
{
  MSSQLInit()
    throws DBException
  {
    ...
    throws DBException
  {
    ...
    try
    {
      String str3 = "./config/db/microsoft/tables.sql";
      ...
      while ((str2 = localBufferedReader.readLine()) != null)
      {
        ...
        if (str2.equalsIgnoreCase("go"))
        {
          ...
          {
            if (localSQLException1.getErrorCode() != 4902)
 ...
 * Qualified Name:     cn.com.jit.ida.ca.initserver.MSSQLInit
