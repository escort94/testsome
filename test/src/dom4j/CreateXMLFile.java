...
public class CreateXMLFile {
	...
	public static void main(String[] args) {
		CreateXMLFile create = new CreateXMLFile();
//		create.createXMLFile(System.getProperty("user.dir") + "/2.xml");
		create.modiXMLFile("./2.xml","./3.xml");
//		create.formatXMLFile(System.getProperty("user.dir") + "/3.xml");
	}
